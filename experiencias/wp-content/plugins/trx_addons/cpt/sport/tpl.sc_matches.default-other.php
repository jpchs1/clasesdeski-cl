...
?><div class="sc_matches_item"><a href="<?php echo esc_url(get_permalink($match['id'])); ?>" class="sc_matches_item_link"><?php
	...
	?><span class="sc_matches_item_date"><span class="sc_matches_item_date_wrap">
		<span class="sc_matches_item_day"><?php echo date("M, d", strtotime($meta['date_start'])); ?></span>
		<span class="sc_matches_item_time"><?php echo date("g:i A", strtotime($meta['time_start'])); ?></span>
	</span></span><?php
	// Match info
