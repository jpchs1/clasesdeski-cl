...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Mounthood
	 * @var $inverse	- added by Mounthood
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Mounthood:
	// Color scheme
	if ($scheme && !mounthood_param_is_off($scheme) && !mounthood_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !mounthood_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Mounthood color scheme in the row
	if ($scheme && !mounthood_param_is_off($scheme) && !mounthood_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
