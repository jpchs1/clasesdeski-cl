	...
	class SPFTESTIMONIAL_Metabox extends SPFTESTIMONIAL_Abstract {
		...
		public function add_meta_box_content( $post, $callback ) {
			...
			if ( 'spt_shortcodes' === $the_current_post_type && $shortcode_show ) {
				?>
				<div class="sptpro-pagination-not-work"><i class="fa fa-check-circle"></i> The pagination will work in the frontend well. </div>
				<div class="sptpro-after-copy-text"><i class="fa fa-check-circle"></i>  Shortcode  Copied to Clipboard! </div>
		<div class="sp-tpro-banner">
		<div class="sp-tpro-logo"><img src="<?php echo esc_url( SP_TPRO_URL . 'Admin/assets/images/real-testimonials-logo.svg' ); ?>" alt="Real Testimonials Pro"></div>
		...
		<div class="tpro_shortcode_content">
			<h2 class="tpro-shortcode-title">
				<?php
				esc_attr_e( 'Shortcode', 'testimonial-pro' );
				?>
			</h2>
			<p><?php esc_attr_e( 'Copy and paste this shortcode into your posts or pages:', 'testimonial-pro' ); ?></p>
			<div class="tpro-sc-code selectable" >[sp_testimonial <?php echo 'id="' . esc_attr( $post->ID ) . '"'; ?>]</div>
		</div>
		</div>
		<div class="tpro-col-lg-6">
		<div class="tpro_shortcode_content">
			<h2 class="tpro-shortcode-title">
				<?php
				esc_attr_e( 'Template Include', 'testimonial-pro' );
				?>
			</h2>
			<p><?php esc_attr_e( 'Paste the PHP code into your template file:', 'testimonial-pro' ); ?></p>
