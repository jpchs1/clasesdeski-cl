...
<a href="#" class="top_panel_cart_button" data-items="<?php echo esc_attr($cart_items); ?>" data-summa="<?php echo esc_attr($cart_summa); ?>">
	<span class="contact_icon icon-basket"></span><span class="cart_summa"><?php mounthood_show_layout($cart_summa); ?></span>
	<span class="contact_label contact_cart_label"><?php esc_html_e('Your cart:', 'mounthood'); ?></span>
</a>
<ul class="widget_area sidebar_cart sidebar"><li>
	<?php
	do_action( 'before_sidebar' );
	mounthood_storage_set('current_sidebar', 'cart');
