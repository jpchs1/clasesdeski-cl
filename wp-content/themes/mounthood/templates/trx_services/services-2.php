...
if ( !function_exists( 'mounthood_template_services_2_theme_setup' ) ) {
	add_action( 'mounthood_action_before_init_theme', 'mounthood_template_services_2_theme_setup', 1 );
	function mounthood_template_services_2_theme_setup() {
		mounthood_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'mounthood'),
...
// Template output
if ( !function_exists( 'mounthood_template_services_2_output' ) ) {
	function mounthood_template_services_2_output($post_options, $post_data) {
