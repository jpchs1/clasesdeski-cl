...
if ( !function_exists( 'mounthood_template_list_theme_setup' ) ) {
	add_action( 'mounthood_action_before_init_theme', 'mounthood_template_list_theme_setup', 1 );
	function mounthood_template_list_theme_setup() {
	}
}

// Template output
if ( !function_exists( 'mounthood_template_list_output' ) ) {
	function mounthood_template_list_output($post_options, $post_data) {
