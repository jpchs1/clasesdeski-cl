...
if ( !function_exists( 'mounthood_template_team_4_theme_setup' ) ) {
	add_action( 'mounthood_action_before_init_theme', 'mounthood_template_team_4_theme_setup', 1 );
	function mounthood_template_team_4_theme_setup() {
		mounthood_add_template(array(
			'layout' => 'team-4',
			'template' => 'team-4',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 4/', 'mounthood'),
			'thumb_title'  => esc_html__('Medium square image 260 (crop)', 'mounthood'),
			'w' => 260,
			'h' => 260
		));
	}
...
// Template output
if ( !function_exists( 'mounthood_template_team_4_output' ) ) {
	function mounthood_template_team_4_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			<div<?php echo !empty($post_options['tag_id']) ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''; ?>
				...
				<div class="sc_team_item_avatar"><?php mounthood_show_layout($post_options['photo']); ?>
					<div class="sc_team_item_hover">
						<div class="sc_team_item_info">
							...
							<div class="sc_team_item_socials"><?php mounthood_show_layout($post_options['socials']); ?></div>
						</div>
					</div>
				</div>
			</div>
