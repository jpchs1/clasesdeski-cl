...
if ( !function_exists( 'mounthood_template_team_3_theme_setup' ) ) {
	add_action( 'mounthood_action_before_init_theme', 'mounthood_template_team_3_theme_setup', 1 );
	function mounthood_template_team_3_theme_setup() {
		mounthood_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 3/', 'mounthood'),
...
// Template output
if ( !function_exists( 'mounthood_template_team_3_output' ) ) {
	function mounthood_template_team_3_output($post_options, $post_data) {
		$show_title = true;
