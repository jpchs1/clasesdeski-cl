...
if ( !function_exists( 'mounthood_template_news_portfolio_theme_setup' ) ) {
	add_action( 'mounthood_action_before_init_theme', 'mounthood_template_news_portfolio_theme_setup', 1 );
	function mounthood_template_news_portfolio_theme_setup() {
		mounthood_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'mounthood'),
...
// Template output
if ( !function_exists( 'mounthood_template_news_portfolio_output' ) ) {
	function mounthood_template_news_portfolio_output($post_options, $post_data) {
